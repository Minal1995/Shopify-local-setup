...
<body>
  ...
  <p>To install Ruby on Ubuntu/Debian:</p>
...
└── theme.liquid
  ...
  <h2>💡 Tips</h2>
  <ul>
    <li>For a better dev experience, use Shopify Dawn as a base theme.</li>
    <li>You can set the store permanently using:
  ...
  <h2>📘 Resources</h2>
  <ul>
    <li>Shopify Theme Dev Docs</li>
    <li>Shopify CLI GitHub</li>
  </ul>

  <hr/>

  <h2>🔐 License</h2>
  <p>This project is for private or internal development. Refer to Shopify’s terms of service for usage policies.</p>
